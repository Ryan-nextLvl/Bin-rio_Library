...
Variáveis de ambiente lidas via python-decouple (.env ou env do sistema).
"""
...
# ── Banco de Dados ────────────────────────────────────────────────────────────
# Em produção: DATABASE_URL=postgres://user:pass@host:5432/dbname
# Em dev local: usa SQLite como fallback automático
DATABASES = {
